...
// usingThen((value) => console.log(value));
// console.log(usingAwait(() => console.log("2 secondes plus tard")));
// console.log(apiResponse("https://jsonplaceholder.typicode.com/todos/1").then((body) => console.log(body)));
